...
def L2_Controls_L1_Requirements() -> Set[Tuple[STRIDE, FrozenSet[Tuple[str, str, str, CONTROL, bool]]]]:
    ...
    query: str = """
        ...
        WHERE {
            ...
            ?l1_requirement_node :requiresControl ?required_control .
            ...
            OPTIONAL {
                ?satisfaction a :ControlSatisfaction ;
                              :satisfiesRequirementOf ?l1_requirement_node ;
                              :satisfiedControl ?required_control ;
                              :isSatisfiedBy ?l2_element .
    ...
    for result in bindings:
        ...
        # Extract control local name (e.g., ClientAuthentication) from URI
