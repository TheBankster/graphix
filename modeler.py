...
CONTROL_TO_STRIDE: Dict[CONTROL, STRIDE] = {
    ...
    CONTROL.TRAFFIC_ENCRYPTION: STRIDE.INFORMATION_DISCLOSURE,
    CONTROL.ENCRYPTION_AT_REST: STRIDE.INFORMATION_DISCLOSURE,
}

# Mapping of control-individual URI fragments (schema vocab) to the CONTROL enum
URI_TO_CONTROL: Dict[str, CONTROL] = {
    "ClientAuthentication": CONTROL.CLIENT_AUTHENTICATION,
    "ServerAuthentication": CONTROL.SERVER_AUTHENTICATION,
    "AccessControl": CONTROL.ACCESS_CONTROL,
    "RateLimiting": CONTROL.RATE_LIMITING,
    "TrafficEncryption": CONTROL.TRAFFIC_ENCRYPTION,
    "EncryptionAtRest": CONTROL.ENCRYPTION_AT_REST,
}
